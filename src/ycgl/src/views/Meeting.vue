<template>
  <div class="meeting ar-container" ref="screen">
      ...
      <el-aside :width="isCollapse ? '64px' : '140px'">
        ...
        <el-menu default-active="1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" :collapse="isCollapse">
          ...
          <el-menu-item index="3">
            <i class="el-icon-menu"></i>
            <span slot="title"><el-button @click="screenShot()">截图</el-button></span>
  ...
  data() {
    return {
      ...
      form: {
        ...
        P004:'继发性胃溃疡',
        HId:'南京第二看守所',
        reason:'病人持续发热付首付款是发了就发了了开发了啥卢卡库冷静冷静',
      },
      textarea: '生命体特征',
      isShow:true,
      // btnText: "隐藏",
  ...
  methods: {
    ...
    initWebSocket() {
      ...
      if (window.WebSocket) {
        ...
        let ws = new WebSocket("wss://kfb.fbtech.cn:8001");
        _this.ws = ws;
